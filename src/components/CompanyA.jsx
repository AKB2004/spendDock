          ...
          <div className={`backdrop-blur-xl ${isDark ? 'bg-gradient-to-br from-white/10 to-white/5' : 'bg-gradient-to-br from-black/10 to-black/5'} rounded-2xl p-8 border ${isDark ? 'border-white/20' : 'border-black/20'} mb-8`}>
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-4">
                <button className={`px-6 py-3 rounded-xl ${isDark ? 'bg-white text-black hover:shadow-xl hover:shadow-white/20' : 'bg-black text-white hover:shadow-xl hover:shadow-black/20'} font-medium transition transform hover:scale-105 cursor-pointer`}>
                  Choose File
                </button>
                <button className={`px-6 py-3 rounded-xl backdrop-blur-xl ${isDark ? 'bg-white/10 hover:bg-white/20 border-white/20' : 'bg-black/10 hover:bg-black/20 border-black/20'} border font-medium ${isDark ? 'text-white' : 'text-black'} transition cursor-pointer`}>
                  Scan Document
                </button>
              </div>
            </div>
